export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'corvsaffinity',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Corvsaffinity',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'corvsaffinity.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://corvsaffinity.com',
